    ...
    <div className="gig">
      <div className="container">
        <div className="left">
          ...
          <p>
            There should be really really long description about my work experience,
            ...
            <div className="box">
              <div className="items">
                <div className="item">
                  ...
                  <span className="desc">Ukraine</span>
                </div>
                <div className="item">
                  <span className="title">Member since</span>
                  <span className="desc">Oct 2023</span>
                </div>
                <div className="item">
                  <span className="title">Avg. response time</span>
                  <span className="desc">18 hours</span>
                </div>
                <div className="item">
                ...
                <div className="item">
                  ...
                  <span className="desc">Ukrainian</span>
                </div>
              </div>
              <hr />
              <p>
                My name is Maryna, I enjoy creating masterpieces work
                in area of programming in my spare
                time.
              </p>
            </div>
          </div>
          <div className="reviews">
            ...
            <div className="item">
              ...
              <p>
                ...
                tutor, and know already that Ill be using it again very very soon
              </p>
